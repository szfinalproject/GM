#pragma once
#ifndef __ANDRIODGAME_SCENE_H__
#define __ANDRIODGAME_SCENE_H__
#include "math.h"
#include <vector>
#include "cocos2d.h"
#include <iostream>
...
class AndriodGame :public cocos2d::Layer
{
	GamePause* gamepause;
public:
